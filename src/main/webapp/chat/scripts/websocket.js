/**
 * Open the WebSocket and store the connection in a global variable.
 * Also, specify the functions to call in response to events
 * associated with the WebSocket.
 */
const wsUri = "ws://" + document.location.host + document.location.pathname + "message-endpoint";
